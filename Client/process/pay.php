...
<div class="header">
        ...
        <div class="bottom">
                        <ul class="menu">
                            ...
                            <li class="menu-list"><a href="http://localhost:8080/hcc/login.php" class="menu-list_item">Đăng Nhập </a></li>
    ...
    <div class="pay">
        ...
        if(isset($_SESSION['id_user']))
        {
            ...
            if(isset($_GET['name']))
            {
                ...
                header('location:http://localhost:8080/hcc/index.php?danhmuc=sanpham');
            }
